...
var gg = -1
var huongdan =1
onready var bullet = preload("res://gameoffline2/Bullet.tscn")
onready var granada = preload("res://gameoffline2/boom.tscn")
var g
var b
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("click"):
		if Global.selected_gun==1:
			...
			g.init(gg)
			if gg==-1:
				g.global_position = $Position2D.global_position
			else:
				g.global_position = $Position2D2.global_position
