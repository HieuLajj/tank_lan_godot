...
func _on_Enemy_spawn_timer_timeout():
	...
	Global.instance_node_1(enemies[enemy_number], enemy_position, self)
...
func _on_Power_up_spawn_timer_timeout():
	...
	Global.instance_node_1(power_ups[power_up_number], Vector2(rand_range(0, 640), rand_range(0, 360)), self)
