...
var blood_particles = preload("res://gameoffline/Scene/Blood_particles.tscn")
...
func _process(_delta):
	if hp <= 0:
		...
		if Global.node_creation_parent != null:
			var blood_particles_instance = Global.instance_node_1(blood_particles, global_position, Global.node_creation_parent)
