...
sync func switch_to_game() -> void:
	for child in Persistent_nodes.get_children():
		...
		#	child.update_shoot_mode(true)
			if child.visible:
				set_rotation(0)
				get_tree().change_scene("res://minigame/minigame1/mapcuoigame.tscn")
	#set_rotation(0)
...
sync func switch_to_game2() -> void:
	for child in Persistent_nodes.get_children():
		...
		#	child.update_shoot_mode(true)
			if child.visible:
				set_rotation(0)
				get_tree().change_scene("res://minigame/minigame2/mapcuoi2.tscn")
sync func switch_to_game3() -> void:
	for child in Persistent_nodes.get_children():
		...
		#	child.update_shoot_mode(true)
			if child.visible:
				set_rotation(0)
				get_tree().change_scene("res://minigame/minigame3/maze.tscn")
sync func switch_to_game4() -> void:
	for child in Persistent_nodes.get_children():
		...
		#	child.update_shoot_mode(true)
			if child.visible:
				set_rotation(0)
				get_tree().change_scene("res://minigame/minigame4/bombminigame.tscn")
