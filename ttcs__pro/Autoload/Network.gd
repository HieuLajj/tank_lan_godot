...
func create_server() -> void:
	...
	Global.instance_node(load("res://Scene/Server_advertiser.tscn"), get_tree().current_scene)
...
func _server_disconnected() -> void:
	...
	if Global.ui != null:
		...
		var prompt = Global.instance_node(load("res://Scene/Simple_prompt.tscn"), Global.ui)
